...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 950000 * (10**9); // user must hold 950,000 token
...
contract OFFICE is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "The Office NFT";
    string constant _symbol = "OFFICE";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 95000000000 * (10 ** _decimals);
